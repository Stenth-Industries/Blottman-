"""Promote the 5 competitor PHRASE negatives (added Jun-11 at campaign level on the
now-PAUSED 'Traffic ticket lawyer broad') to the shared list
'Master Negatives - Blottman (Stenth)' (12109076551) so the new consolidated Search
campaign + PMAX are covered. 'excopper' impressions seen Jul-1 on the new campaign.
...
NEW_NEGS = [
    # competitor brands from Jun-11 search-term leaks (were campaign-level on paused broad)
    "amar traffic tickets",
    "benito zappia",
    "x copper",
    "ex copper",
    "xcopper",
    "excopper",  # the exact single-token variant seen Jul-1 (not matched by the above)
]
