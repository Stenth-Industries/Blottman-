"""Add informational/DIY-intent PHRASE negatives to the shared list
'Master Negatives - Blottman (Stenth)' (12109076551). Trigger: Jul-1 search terms
on the consolidated Search campaign — paid clicks on "how many points for cell
phone ticket", "what is the fine for...", "definition of careless driving",
"how to pay speeding ticket ontario" (leaked past '[PHR] pay ticket' — different
token sequence). These are researchers/DIY-payers, not hire intent.
Deliberately NOT negating: "how to fight..." (converts), "demerit points"/"fine"
alone (mixed intent — a charged person researching consequences can still hire).
Idempotent — skips terms already in the list. Same pattern as
promote_competitor_negs.py."""
...
NEW_NEGS = [
    # DIY-pay intent that slips past '[PHR] pay ticket' (needs its own token sequence)
    "how to pay",
    # pure research modifiers seen in Jul-1 paid clicks / impressions
    "definition of",
    "what is considered",
    "what qualifies as",
]
